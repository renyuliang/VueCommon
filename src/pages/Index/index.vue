  ...
  methods: {
    ...
    loadTableData () {
      ...
      if (sessionStorage.length > 0) {
        vm.searchBuffer22 = {}
        vm.searchBuffer22 = Object.assign(vm.searchBuffer22, sessionStorage)
      }
      vm.tableData22 = [
        {
          date: "2016-05-02",
    ...
    handleSizeChange (val) {
      ...
      this.currentPage = 1
      this.pageSize = val
      this.searchBuffer22.pageSize = val
    },
    handleCurrentChange (val) {
      console.log(`当前页: ${val}`)
      this.currentPage = val
      // this.storeNum = val
      this.searchBuffer22.currentPage = val
    },
    storeSearch () {
      let vm = this
      for (var i in vm.searchBuffer22) {
        sessionStorage.setItem(i, vm.searchBuffer22[i])
      }
    ...
    reset () {
      ...
      this.searchBuffer22.name = ''
      this.searchBuffer22.phone = ''
    },
